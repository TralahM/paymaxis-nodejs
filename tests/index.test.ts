...
import { APIUserAbortError } from 'paymaxis';
import { Headers } from 'paymaxis/core';
...
describe('instantiate client', () => {
  ...
  describe('baseUrl', () => {
    ...
    afterEach(() => {
      process.env['PAYMAXIS_BASE_URL'] = undefined;
    });

    test('explicit option', () => {
      const client = new Paymaxis({ baseURL: 'https://example.com', bearerToken: 'My Bearer Token' });
    ...
    test('empty env variable', () => {
      process.env['PAYMAXIS_BASE_URL'] = ''; // empty
      const client = new Paymaxis({ bearerToken: 'My Bearer Token' });
      expect(client.baseURL).toEqual('https://app-sandbox.paymaxis.com');
    });

    test('blank env variable', () => {
      process.env['PAYMAXIS_BASE_URL'] = '  '; // blank
      const client = new Paymaxis({ bearerToken: 'My Bearer Token' });
      expect(client.baseURL).toEqual('https://app-sandbox.paymaxis.com');
    });
  ...
  test('maxRetries option is correctly set', () => {
    const client = new Paymaxis({ maxRetries: 4, bearerToken: 'My Bearer Token' });
    expect(client.maxRetries).toEqual(4);

    // default
    const client2 = new Paymaxis({ bearerToken: 'My Bearer Token' });
...
describe('retries', () => {
  test('retry on timeout', async () => {
    ...
    const client = new Paymaxis({ bearerToken: 'My Bearer Token', timeout: 10, fetch: testFetch });
  ...
  test('retry count header', async () => {
    ...
    const client = new Paymaxis({ bearerToken: 'My Bearer Token', fetch: testFetch, maxRetries: 4 });
  ...
  test('retry on 429 with retry-after', async () => {
    ...
    const client = new Paymaxis({ bearerToken: 'My Bearer Token', fetch: testFetch });
