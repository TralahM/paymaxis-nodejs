...
import { Subscription, SubscriptionUpdateParams, Subscriptions } from './resources/subscriptions';
import {
  Payment,
  PaymentCreateParams,
  PaymentListParams,
...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['PAYMAXIS_BASE_URL'].
   */
 ...
 */
export class Paymaxis extends Core.APIClient {
  bearerToken: string;
  ...
  static PaymaxisError = Errors.PaymaxisError;
...
Paymaxis.Payments = Payments;
Paymaxis.Subscriptions = Subscriptions;
export declare namespace Paymaxis {
